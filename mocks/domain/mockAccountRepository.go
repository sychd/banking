...
// Source: github.com/sychd/banking/domain (interfaces: AccountRepository)
...
import (
	...
	domain "github.com/sychd/banking/domain"
	errs "github.com/sychd/banking/errs"
)
...
func (m *MockAccountRepository) ById(arg0 string) (*domain.Account, *errs.AppError) {
	m.ctrl.T.Helper()
